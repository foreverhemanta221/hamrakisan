...
@section('body')
    ...
    <section class="content">
        <div class="box box-body">
            <div class="row">
                <div class="col-md-8">
                    <form class="form-horizontal" method="post" action="{{route('farmproduct.translate.submit',$product->id)}}" enctype="multipart/form-data">
                        @csrf
                        {{method_field('put')}}
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <input type="text" class="form-control" id="inputName" placeholder="Product Name" name="nep_name" value="{{isset($product->nep_name) ? $product->nep_name : $product->name}}">
                                @if($errors->has('nep_name'))
                                    <span style="color: red">{{$errors->first('nep_name')}}</span>
                                @endif
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <input type="number" class="form-control" id="inputName" placeholder="Product Name" name="minimum_quantity" value="{{$product->minimum_quantity}}" disabled>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <input type="text" class="form-control" id="inputName" placeholder="Measurement Unit" name="measure_unit" value="{{$product->measure_unit}}" disabled>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <input type="text" class="form-control" id="rate" placeholder="Rate" name="rate" value=" {{$product->price}}" disabled>
                                @if($errors->has('rate'))
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <textarea class="form-control" id="description" name="nep_description">{{ isset($product->nep_description) ? $product->nep_description :  $product->description}}</textarea>
                                @if($errors->has('nep_description'))
                                    <span style="color: red">{{$errors->first('nep_description')}}</span>
                                @endif
                            </div>
                        </div>
                ...
                <div class="col-md-4">
                    ...
                    <img src="{{URL::asset($product->product_image)}}" alt="" style="width: 100%">
