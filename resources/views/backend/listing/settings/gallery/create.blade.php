                            ...
                            <div class="row">
                                ...
                                <div class="col-md-12">
                                    <div class="form-group {{ $errors->has('features') ? ' has-error' : '' }}">
                                        <label>Features and services <span style="color: #ff0000">*</span></label>
                                        @if($errors->has('features'))
                                            <span class="help-block">{{ $errors->first('features') }}</span>
                                        @endif
                                        <textarea name="features" class="form-control" id="features" rows="5" cols="80" ></textarea>
                                    </div>
                                </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group {{ $errors->has('landmark') ? ' has-error' : '' }}">
                                        ...
                                        @endif
                                        <input type="text" name="landmark" id="title" class="form-control">
                                    </div>
                                    <!-- /.form-group -->
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group {{ $errors->has('cp_role') ? ' has-error' : '' }}">
                                        ...
                                        @endif
                                        <input type="text" name="cp_role" id="cp_role" class="form-control"  >
                                    </div>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group {{ $errors->has('logo') ? ' has-error' : '' }}">
                                        ...
                                        @endif
                                        <input type="file" name="logo" id="title" class="form-control">
                                    </div>
                                    <!-- /.form-group -->
