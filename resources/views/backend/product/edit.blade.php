...
@section('body')
    ...
    <section class="content">
        <form method="post" action="{{route('products.update',$productedit->id)}}" enctype="multipart/form-data">
            {{method_field('put')}}
            {{csrf_field()}}
            <div class="row">
                <div class="col-md-12">
                    <div class="box box-info">
                        ...
                        <div class="box box-body">
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group {{ $errors->has('title') ? ' has-error' : '' }}">
                                        ...
                                        <input type="text" name="title" id="title" class="form-control" value="{{$productedit->name}}">
                                        @if($errors->has('title'))
                                    ...
                                    <div class="form-group {{ $errors->has('category') ? ' has-error' : '' }}">
                                        ...
                                        <select class="form-control " name="category">
                                            @foreach($allcategory as $cat)
                                                <option value="{{$cat->id}}" {{$cat->id == $productedit->catgory_id ? 'selected':''}} >{{$cat->name}}</option>
                                            @endforeach
                                        </select>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="form-group {{ $errors->has('price') ? ' has-error' : '' }}">
                                        ...
                                        <input type="text" class="form-control" name="price" value="{{$productedit->price}}">
                                        @if($errors->has('price'))
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    ...
                                    <div class="form-group {{ $errors->has('measure_unit') ? ' has-error' : '' }}">
                                        ...
                                        <input type="text" class="form-control" name="measure_unit" value="{{$productedit->measure_unit}}">
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <img src="{{$productedit->getFeatureImage('small')}}" alt="">
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group {{ $errors->has('about') ? ' has-error' : '' }}">
                                        ...
                                        @endif
                                        <textarea name="about" class="form-control" id="about" rows="5" cols="80" >{{$productedit->description}}</textarea>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div id="rawrowContainer">
                        <div class="rawrowContent"> <br>
                            ...
                            <div class="row">
                                ...
                                @if($productedit->other_info!=null && gettype(json_decode($productedit->other_info)) =='object')
                                   @foreach(json_decode($productedit->other_info) as $key=>$value)

                                        <div class="col-md-6 col-sm-12">
                                                <div class="form-group row">
                                                    <label for="fullName" class="col-sm-3 col-form-label">Label</label>
                                                    <div class="col-sm-9">
                                                        <input type="text" class="form-control plaintext antichain-raw-label" name="label[]" value="{{$key}}" >
                                                    </div>
                                                </div>
                                        </div>
                                        <div class="col-md-6 col-sm-12">
                                            <div class="form-group row">
                                                <label for="fullName" class="col-sm-3 col-form-label">Value</label>
                                                <div class="col-sm-9">
                                                    <input type="text" class="form-control plaintext" name="value[]" value="{{$value}}" >
                                                </div>
                                            </div>
                                        </div>
                                    @endforeach
                        ...
                        <div class="pull-right">
                            <a class="addrawbtn btn btn-primary btn-sm formaddremovebtn" onclick="addrawrow()"  style="padding:5px 10px!important;border:0px;background:#00C2ED;color:white;">Add  </a>
                            <a class="removerawbtn btn btn-primary btn-sm formaddremovebtn" onclick="removerawrow()"  style="padding:5px 10px!important;border:0px;background:#DD4B39;color:white;display:none;">Remove  </a>
                        </div>
