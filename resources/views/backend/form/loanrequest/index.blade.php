                ...
                <table id="example1" class="table table-bordered table-striped">
                    ...
                    @foreach($farmlist as $farmrequest)
                        <tr>
                            ...
                            <td>{{$farmrequest->loanAmount}}</td>
                            <td>{{$farmrequest->phone}}</td>
                            <td>{{$farmrequest->location}}</td>
                            <td>{{$farmrequest->farmType}}</td>
                            <td>
                                <a href="{{route('loanrequest.show',$farmrequest->id)}}" class="btn btn-xs btn-info" style=" border-radius: 0px;"><i class="fa fa-edit"></i>Show</a>
